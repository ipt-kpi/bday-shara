<template>
  <v-container>
      ...
      <v-list dense>
        ...
        <span v-if="$store.state.user.login">
          ...
          >
            ...
            <v-list-item link @click="$router.push('/admin/prize/lottery')">
              <v-list-item-action>
                <v-icon>mdi-tooltip-edit</v-icon>
              </v-list-item-action>
              <v-list-item-content>
                <v-list-item-title>Розыгрыш</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-list-group>
    ...
    <v-app-bar app>
      ...
      <span id="title">
        <v-toolbar-title @click="$router.push('/')">BDay-Shara</v-toolbar-title>
      </span>
      <span class="hidden-md-and-down">
        ...
        <span v-if="$store.state.user.admin">
          <v-menu offset-y>
            ...
            <v-list>
              <v-list-item @click="$router.push('/admin/prize/lottery')">
                <v-list-item-title>Розыгрыш</v-list-item-title>
              </v-list-item>
            </v-list>
          </v-menu>
